...
import { IconBook, IconFileText, IconArrowRight, IconFolder } from '@tabler/icons-react';
...
export default function DocumentationIndex({
  ...
  const locales = Array.isArray(availableLocales) ? availableLocales : [locale];
        ...
        <main className="container py-12 px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <div className="flex justify-center gap-4">
              <Link
                href={`/docs/${locale}/getting-started`}
          ...
          {categoryList.length > 0 ? (
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground line-clamp-2">
                        {category.description || `Explore ${category.title || category.slug}`}
                      </p>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">Start by creating your first documentation category</p>
            </div>
          )}
