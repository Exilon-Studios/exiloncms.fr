...
export default function CreateVoteSite({ auth }: PageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.votes.sites.store'));
    };

    return (
        <AuthenticatedLayout>
            <Head title="Add Vote Site" />
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Add Vote Site</h1>
                        <p className="text-muted-foreground">
                            Add a new voting website to your server
                        </p>
                    </div>
                </div>
