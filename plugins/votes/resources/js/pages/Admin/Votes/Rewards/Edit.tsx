...
export default function EditVoteReward({ reward, roles }: PageProps & Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.votes.rewards.update', reward));
    };
        ...
        <AuthenticatedLayout>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Edit Vote Reward</h1>
