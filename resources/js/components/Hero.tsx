...
/**
 * Hero Section - Modular component with installer-style design
 * Can be used standalone or combined with Navbar
 */
    ...
    <div className="min-h-screen flex bg-background">
      ...
      <div className="flex-1 flex flex-col justify-center p-15 bg-muted/30 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground text-base mb-6 max-w-[320px] leading-relaxed">
            {description || 'Modern CMS for gaming communities'}
          </p>

          {/* Customization note */}
          {showCustomizationNote && (
            <p className="text-muted-foreground/60 text-xs mb-9 max-w-[320px]">
              Customize this page in Admin → Pages. Modify colors, layout, and content to match your style.
            </p>
          )}
