            ...
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <div>
                <Button type="submit" disabled={processing}>
                  {processing ? t('messages.loading') : t('auth.login')}
                </Button>
            ...
            <div className="mt-10 hidden">
              ...
              <div className="mt-6 space-y-3">
                ...
                >
                  ...
                  {t('auth.sign_in_with')} {t('auth.google')}
                </button>
                ...
                >
                  ...
                  {t('auth.sign_in_with')} {t('auth.discord')}
                </button>
              </div>
...
export const Input = ({
  ...
  return (
    <input
      className={cn(
        "block w-full rounded-lg border-0 bg-background/50 px-4 py-2 text-foreground shadow-sm ring-1 ring-inset ring-border placeholder:text-muted-foreground focus:ring-2 focus:ring-primary sm:text-sm sm:leading-6 transition-all",
        className,
      )}
      {...props}
    />
