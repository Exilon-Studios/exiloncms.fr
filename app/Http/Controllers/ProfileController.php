...
class ProfileController extends Controller
{
    ...
    public function show2fa(Request $request)
    {
        if ($request->user()->hasTwoFactorAuth()) {
            return Inertia::render('Profile/TwoFactor/Index', [
                'user' => $request->user(),
        ...
        return Inertia::render('Profile/TwoFactor/Enable', [
            'secret' => $secret,
            'qrCode' => QrCodeRenderer::render($qrCodeUrl, 250),
        ]);
    }
    ...
    {
        return Inertia::render('Profile/Delete', ['confirmDelete' => false]);
    }
    ...
    {
        return Inertia::render('Profile/Delete', ['confirmDelete' => true]);
    }
